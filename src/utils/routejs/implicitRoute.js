...
const RouteBuilder = (customRouteContext) => {
	console.info('skyline: routeType implicit')
	const {
		primaryAnimation,
...
function implicitRouteBuilder() { 
  wx.router.addRouteBuilder('implicitRoute',RouteBuilder)
}

export default implicitRouteBuilder
