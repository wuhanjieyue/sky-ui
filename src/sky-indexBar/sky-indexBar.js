...
Component({
  ...
  methods: {
    ...
    _handlePan(e) {
      ...
      const clientY = e.absoluteY
      const index = Math.round((clientY - data._anchorTop) / data._anchorItemH)
    ...
    selectItem(e){
        ...
        this.triggerEvent('selectItem', {"name":name,"index":index,"subIndex":subIndex}, {})
    },
    touchAcc(e){
      'worklet'
      return true
    ...
    touchPan(e){
      "worklet"
      if(e.state >= 3){
        wx.worklet.runOnJS(this.cancelPan.bind(this))()
      }else{
        wx.worklet.runOnJS(this._handlePan.bind(this))(e)
